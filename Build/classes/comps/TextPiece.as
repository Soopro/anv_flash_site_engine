package comps{
	...
	public class TextPiece extends Sprite {
		...
		public function TextPiece() {
			seted=false;
			this.mouseEnabled=false;
			this.mouseChildren=false;
		}

		public function setup(str:String="",pm_w:int=0,pm_h:int=0,link:Boolean=false):void {
			...
			if (str=="") {
				...
				if (pm_h!=0) {
					...
					txt.height=Math.ceil(txt.textHeight+TextStyle.getFormat.size);
				}
			}
		}
